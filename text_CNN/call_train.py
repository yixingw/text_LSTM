...
for learing_rate in learning_rate_list:
	command = "python train_CNN.py -ckpt_dir checkpoint_drop_out_"+str(learing_rate)+'/ -learning_rate '+str(learing_rate)+' -save_file_name '+'error_hist_drop_out'+str(learing_rate)+'.p'
	print command
